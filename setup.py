...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'ddsp_fm_run = ddsp.training.ddsp_fm_run:console_entry_point',
            'ddsp_prepare_tfrecord = ddsp.training.data_preparation.ddsp_prepare_tfrecord:console_entry_point',
            'ddsp_prepare_fm_dataset = ddsp.training.data_preparation.ddsp_prepare_fm_dataset:console_entry_point',
